export const homeObjOne = {
  ...
  lightTextDesc: true,
  topLine: 'Search Game',
  headline: 'Detailed information of all games in one database.',
  description:
...
export const homeObjTwo = {
  ...
  topLine: 'Popular Games',
  headline: 'We have the information of all popular games.',
  description: 'You can access the most popular games by week, month, year.',
...
export const homeObjThree = {
  ...
  lightTextDesc: true,
  topLine: 'About Us',
  headline: 'We are so confident thanks to the powerful API we use.',
  description:
